...
try:
    ...
    print(f"Warning: subtitles module not available: {e}")
...
try:
    ...
    print(f"Warning: subtitles_fallback module not available: {e}")
...
def get_video_subtitles():
    ...
    try:
        ...
        # ESSAYER D'ABORD LA MÉTHODE FALLBACK
        ...
        return jsonify({
            'error': 'Aucune méthode de sous-titres disponible. Vérifiez que la vidéo a des sous-titres.'
        }), 404
...
def get_available_languages(video_id):
    try:
        ...
        # Vous pourrez améliorer cette fonction plus tard
        languages = [
